...
# DO NOT DELETE IMPORTANT FUNCTION IF DELETED REST OF CLASS BREAKS 
    async def GetBoardCard(self, CardName):
...
# DO NOT DELETE IMPORTANT FUNCTION IF DELETED REST OF CLASS BREAKS
    async def GetBoardList(self, ListName):
...
# DO NOT DELETE IMPORTANT FUNCTION IF DELETED REST OF CLASS BREAKS
    async def GetBoardLabel(self, LabelName):
    ...
    async def CreateCard(self, Name=None, Desc=None, List=None, Label=None):
    ...
    async def GetListCards(self, List=None):
    ...
    async def EditCardName(self,Name=None,Card=None):
        ID = self.GetBoardCard(Card)['id']
        AuthDict['name'] = Name
        Response = requests.request("PUT",url=f'https://api.trello.com/1/cards/{ID}',params=AuthDict)
        print(Response)

    async def EditCardDesc(self,Desc=None,Card=None):
        ID = self.GetBoardCard(Card)['id']
        AuthDict['desc'] = Desc
        Response = requests.request("PUT",url=f'https://api.trello.com/1/cards/{ID}',params=AuthDict)
        print(Response)

    async def AddLabel(self, Card=None, Label=None):
        ID = self.GetBoardCard(Card)
        AuthDict['idLabels'] = self.GetBoardLabel(Label)['id']
        Response = requests.request("PUT",url=f'https://api.trello.com/1/cards/{ID}',params=AuthDict)
        print(Response)
    
    async def RemoveLabel(self,Card=None, Label=None):
    ...
    async def Move(self,Card=None, List=None):
        ID = self.GetBoardCard(Card)['id']
        AuthDict['idList'] = self.GetBoardList(List)['id']
        Response = requests.request("PUT",url=f'https://api.trello.com/1/cards/{ID}',params=AuthDict)
        print(Response)

    async def CreateList(self, Name=None):
        AuthDict['name'] = Name
